...
def test_victoire(grille_jeu) :
    ...
    liste_return = []
    total = 0
    for idx_case in range(0,9,3) :
        total += grille_jeu[idx_case]
    if total == 3 or total == -3 :
        liste_return.append(total)
        liste_return.append(1)
        return liste_return
    
    total = 0
    for idx_case in range(1,9,3) :
        total += grille_jeu[idx_case]
    if total == 3 or total == -3 :
        liste_return.append(total)
        liste_return.append(1)
    ...
    if addition_diago1 == 3 :
        print(f"{dicoj1['pseudo']} a gagné !")
        return 1
    elif addition_diago1 == - 3 :
        print(f"{dicoj2['pseudo']} a gagné !")
        return -1
